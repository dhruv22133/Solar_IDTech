    ...
    <div class="col p-md-0">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          ...
          <a href="javascript:void(0)">Temp Assets</a>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
              ...
              <div class="card-header"><a class="btn btn-warning" href="<?php echo base_url('index.php/ManageAssets/ViewsTempAssets');?>"><i class="fa fa-arrow-left"></i>  </a>Edit Asset Details</div>
            ...
            <div class="card-body">
              ...
              <div class="form-validation">
                ...
                <form class="form-valide" action="<?php echo base_url('index.php/Assets/Edit_Temp_Asset/'.$id);?>" method="post">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" minlength="8" maxlength="24" value="<?php if(!empty($assetdata)){echo $assetdata[0]['tag_id'];}?>" class="form-control input-rounded" id="val-username" name="tag_id" placeholder="Enter Tag Id..">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control input-rounded" value="<?php if(!empty($assetdata)){echo $assetdata[0]['asset_name'];}?>" name="asset_name" placeholder="asset name." required>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control input-rounded" name="value" value="<?php if(!empty($assetdata)){echo $assetdata[0]['value'];}?>" placeholder="Asset value.." required>
                   ...
                   <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control input-rounded" name="facility" value="<?php if(!empty($assetdata)){echo $assetdata[0]['facility'];}?>" placeholder=" facility.." required>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                        <input type="text" class="form-control input-rounded" name="region" value="<?php if(!empty($assetdata)){echo $assetdata[0]['region'];}?>" placeholder=" region.." readonly>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control input-rounded" name="city" value="<?php if(!empty($assetdata)){echo $assetdata[0]['city'];}?>" placeholder=" city.." readonly>
                     ...
                     <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="date" class="form-control input-rounded" value="<?php if(!empty($assetdata)){echo $assetdata[0]['date_of_commissioning'];}?>" name="date_of_commissioning" placeholder=" Date of Commissioning...."required>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control input-rounded" value="<?php if(!empty($assetdata)){echo $assetdata[0]['vendor'];}?>" name="vendor" placeholder="Enter Vendor.."required>
                 ...
                 <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <select name="location" id="locationsel" class="form-control input-rounded" disabled>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control input-rounded" name="equipment_brand" value="<?php if(!empty($assetdata)){echo $assetdata[0]['equipment_brand'];}?>" placeholder="Enter Equipment Brand.."readonly>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="date" class="form-control input-rounded" value="<?php if(!empty($assetdata)){echo $assetdata[0]['date_of_installation'];}?>" name="date_of_installation" placeholder="Enter Date of installation.."required>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control  input-rounded" name="Specification" value="<?php if(!empty($assetdata)){echo $assetdata[0]['Specification'];}?>" placeholder=" Specification">
                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                          <select class="form-control input-rounded" name="asset_status" >

                            <option value="">Select Asset Status</option>

                            <?php if($asset_status){ foreach ($asset_status as $status){?>

                            <option value="<?php echo $status['id'] ?>" <?php if($status['id'] == $assetdata[0]['asset_status']){ echo "selected";}?>><?php echo $status['status_name']; ?></option>
                     ...
                     <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control input-rounded" value="<?php if(!empty($assetdata)){echo $assetdata[0]['Remarks'];}?>" name="Remarks" placeholder="Enter Remarks..">
                        </div>
                      </div>
                    </div>
                  </div>
