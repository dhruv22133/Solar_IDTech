      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">Plant Master</a>
            </li>
         </ol>
      </div>
   </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">Plant Master</div>
                  </div>
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/Plant');?>" method="POST">
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input class="form-control input-rounded" name="plantname" value="<?php echo set_value('plantname'); ?>" required>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input class="form-control input-rounded" name="plantemail" value="<?php echo set_value('plantemail'); ?>" required>
                                    </div>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="table-responsive" style="overflow-x:auto; ">
                        <script>
                           function doconfirm(){
                            job=confirm("Are you sure to delete Plant permanently?");
                            if(job!=true){
                              return false;
                            }
                          }
                          function docedit(){
                            job=confirm("Are you sure to Edit Plant asset ?");
                            if(job!=true){
                              return false;
                            }
                          }
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="<?= base_url('Master/Delete_Plant/'.$plant['id']); ?>">
                                    ...
                                    <a href="<?= base_url('Master/Edit_Plant/'.$plant['id']); ?>">
