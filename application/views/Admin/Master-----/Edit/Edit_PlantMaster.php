    ...
    <div class="col p-md-0">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
          <a href="javascript:void(0)">Edit Plant</a>
        </li>
      </ol>
    </div>
  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input class="form-control input-rounded" name="plantname" value="<?php if(!empty($plant)){echo $plant[0]['plant_name'];}?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input class="form-control input-rounded" name="plantemail" value="<?php if(!empty($plant)){echo $plant[0]['plant_email'];}?>" required>
                        </div>
                      </div>
                    </div>
                  </div>
