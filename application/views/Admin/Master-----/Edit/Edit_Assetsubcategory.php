          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php if($this->session->flashdata('msg') != ''): ?>
                ...
                <?php endif; ?>
                <form action="<?php echo base_url('index.php/Master/Edit_Assetsubcategory/'.$id);?>" method="POST">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">
                      <b>Sub Category Name</b>
                    </label>
               <div class="col-sm-8">
                      <input class="form-control input-rounded" name="Assetsubcategory" value="<?php if(!empty($subcat)){echo $subcat[0]['Assetsubcategory'];}?>" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-10">
                      <button type="submit" name="submit" class="btn btn-primary">Submit</button>
                        <a class="btn btn-warning" href="<?php echo base_url('Master/Assetsubcategory');?>"> ❮ Go Back</a>
                    </div>
                  </div>
                </form>
              </div>
