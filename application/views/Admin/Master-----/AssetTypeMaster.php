      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">Asset Type Master</a>
            </li>
         </ol>
      </div>
   </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">Asset Type Master</div>
                  </div>
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/Asset_Type');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Asset Type name</b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="asset_type_name" value="<?php echo set_value('asset_type_name'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
            ...
            <div class="col-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     <script>
                           function doconfirm(){
                            job=confirm("Are you sure to delete Asset Type?");
                            if(job!=true){
                              return false;
                            }
                          }
                          function docedit(){
                            job=confirm("Are you sure to Edit Asset Type?");
                            if(job!=true){
                              return false;
                            }
                          }
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="<?= base_url('Master/Delete_Asset_Type/'.$type['id']); ?>">
                                    ...
                                    <?php if (!empty($privilledge) && strpos($privilledge[0]['pr_id'], "7") !== false){?>
                                       ...
                                       <a href="<?= base_url('Master/Edit_Asset_Type/'.$type['id']); ?>">
