               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/CostCenter');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Cost Center Name</b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="CostCenter" value="<?php echo set_value('CostCenter'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="table-responsive" style="overflow-x:auto; ">
                      <script>
                           function doconfirm(){
                            job=confirm("Are you sure to delete Cost Center?");
                            if(job!=true){
                              return false;
                            }
                          }
                          function docedit(){
                            job=confirm("Are you sure to Edit Cost Center?");
                            if(job!=true){
                              return false;
                            }
                          }
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <?php if (!empty($privilledge) && strpos($privilledge[0]['pr_id'], "7") !== false){?>
                                       ...
                                       <a href="<?= base_url('Master/Edit_AssetCostCenter/'.$cost['id']); ?>">
