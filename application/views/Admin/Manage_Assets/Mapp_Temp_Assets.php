													...
													<?php endif; ?>
														<form action="<?php echo base_url('index.php/Master/Location');?>" method="POST">
															<div class="form-group row">
																<label class="col-sm-2 col-form-label"> <b>Finance Id</b> </label>
																<div class="col-sm-8">
																	<input class="form-control input-rounded" name="locname" value="<?php echo set_value('locname'); ?>" required> </div>
															</div>
															<div class="form-group row">
																<div class="col-sm-10">
				...
				<div class="col-12">
                    ...
                    foreach($locations as $loc){ ?>
											<tr>
												...
												<td>
													<a href="<?= base_url('index.php/Master/DeleteLocation/'.$loc['id']); ?>">
													...
													<a href="<?= base_url('index.php/Master/Edit_Location/'.$loc['id']); ?>">
