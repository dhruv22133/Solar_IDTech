               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/vendor');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Vendor Name </b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="vendor" value="<?php echo set_value('vendor'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
                  ...
                  <div class="card-body">
                     <script>
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to delete vendor  permanently?");
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to Edit vendor  ?");
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="<?= base_url('Master/Delete_vendor/'.$row['id']); ?>">
                                    ...
                                    <a href="<?= base_url('Master/Edit_vendor/'.$row['id']); ?>">
