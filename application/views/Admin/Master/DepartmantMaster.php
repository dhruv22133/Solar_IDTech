      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">Department Master</a>
            </li>
         </ol>
      </div>
   </div>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/Departmant');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Departmant name</b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="deptname" value="<?php echo set_value('depname'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
                  ...
                  <div class="card-body">
                     <script>
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to delete Department permanently?");
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to Edit Department asset ?");
                        ...
                        <table id="example" class=" table-striped table-bordered zero-configuration">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><?= $dep['id']; ?></td>
                                 <td><?= $dep['dep_name']; ?></td>
                                 <td><?= $dep['created_by']; ?></td>
                                 <td>
                                    <?php if (!empty($privilledge) && strpos($privilledge[0]['pr_id'], "8") !== false){?>
                                    <a href="<?= base_url('Master/DeleteDept/'.$dep['id']); ?>">
                                    ...
                                    <a href="<?= base_url('Master/Edit_Dept/'.$dep['id']); ?>">
