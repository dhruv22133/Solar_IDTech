      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">Country Detail Master</a>
            </li>
         </ol>
      </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">Country Detail Master</div>
                  </div>
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <fieldset style="border:1px solid #999; border-radius:8px;" class="flex-fill">
                           <legend class="w-auto" style="text-align: center;">Country Details</legend>
                           <form action="<?php echo base_url('index.php/Master/country_details'); ?>" method="POST">
                              <div class="form-group row ml-2">
                                 <label class="col-sm-2 col-form-label">
                                    <b>Country name</b>
                                 </label>
                                 <div class="col-sm-8" style="text-align: center;">
                                    <input class="form-control input-rounded" name="country_details" value="<?php echo set_value('country_name'); ?>" required>
                                 </div>
                              </div>
               ...
               <div class="card">
                  ...
                  <script>
...

                     {
                        ...
                        job = confirm("Are you sure to delete Country Detail permanently?");
...

                     {
                        ...
                        job = confirm("Are you sure to Edit  Country Details ?");
