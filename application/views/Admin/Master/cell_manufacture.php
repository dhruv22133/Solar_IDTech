      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">Cell Manufacture Master</a>
            </li>
         </ol>
      </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">Cell Manufacture Master</div>
                  </div>
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <fieldset style="border:1px solid #999; border-radius:8px;" class="flex-fill">
                           <legend class="w-auto" style="text-align: center;">Cell Manufacturer</legend>
                           <form action="<?php echo base_url('index.php/Master/cell_manufacture'); ?>" method="POST">
                              <div class="form-group row ml-2">
                                 <label class="col-sm-2 col-form-label">
                                    <b>Cell Manufacturer</b>
                                 </label>
                                 <div class="col-sm-8">
                                    <input class="form-control input-rounded" name="cell_manufacture" value="<?php echo set_value('cell_manufacture'); ?>" required>
                                 </div>
                              </div>
                              <div class="form-group row ml-2">
                                 <div class="col-sm-10">
               ...
               <div class="card">
                  ...
                  <script>
...

                     {
                        ...
                        job = confirm("Are you sure to delete Cell Manufacturer permanently?");
...

                     {
                        ...
                        job = confirm("Are you sure to Edit  Cell Manufacutrer Details ?");
