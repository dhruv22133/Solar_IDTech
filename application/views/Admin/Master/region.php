               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/region');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Region </b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="region" value="<?php echo set_value('region'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
                  ...
                  <div class="card-body">
                     <script>
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to delete Region  permanently?");
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to Edit Region  ?");
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="<?= base_url('Master/Delete_region/'.$row['id']); ?>">
                                    ...
                                    <a href="<?= base_url('Master/Edit_region/'.$row['id']); ?>">
