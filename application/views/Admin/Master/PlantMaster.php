      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">City(Office) Master</a>
            </li>
         </ol>
      </div>
   </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">City(Office) Master</div>
                  </div>
                  <div class="card-body">
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input class="form-control input-rounded" name="plant_name" value="<?php echo set_value('plant_name'); ?>" required>
                                    </div>
                                 </div>
                              </div>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="table-responsive" style="overflow-x:auto; ">
                        <script>
                           function doconfirm(){
                            job=confirm("Are you sure to delete City(Office) permanently?");
                            if(job!=true){
                              return false;
                            }
                          }
                          function docedit(){
                            job=confirm("Are you sure to Edit City(Office) name ?");
                            if(job!=true){
                              return false;
                            }
                          }
