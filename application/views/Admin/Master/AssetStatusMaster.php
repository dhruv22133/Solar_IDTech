      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">Asset Status Master</a>
            </li>
         </ol>
      </div>
   </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">Asset Status Master</div>
                  </div>
                  <div class="card-body">
                     ...
                     <div class="basic-form">
                        <form action="<?php echo base_url('index.php/Master/Asset_Status');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Status name </b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="satus_name" value="<?php echo set_value('satus_name'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
            ...
            <div class="col-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     <script>
                           function doconfirm(){
                            job=confirm("Are you sure to delete Asset Status?");
                            if(job!=true){
                              return false;
                            }
                          }
                          function docedit(){
                            job=confirm("Are you sure to Edit Asset Status?");
                            if(job!=true){
                              return false;
                            }
                          }
                        ...
                        <table id="example" class=" table-striped table-bordered zero-configuration">
                           ...
                           <tbody>
                              <?php  $count=1;
                                 ...
                                 foreach($status as $assetstatus){ ?>
                              <tr>
                                 <td><?= $count; ?></td>
                                 <td><?= $assetstatus['id']; ?></td>
                                 <td><?= $assetstatus['status_name']; ?></td>
                                 <td><?= $assetstatus['created_by']; ?></td>
                                 <td>
                                    <?php if (!empty($privilledge) && strpos($privilledge[0]['pr_id'], "8") !== false){?>
                                    <a href="<?= base_url('Master/Delete_Status/'.$assetstatus['id']); ?>">
                                    ...
                                    <?php if (!empty($privilledge) && strpos($privilledge[0]['pr_id'], "7") !== false){?>
                                       <a href="<?= base_url('Master/Edit_AssetStatus/'.$assetstatus['id']); ?>">
