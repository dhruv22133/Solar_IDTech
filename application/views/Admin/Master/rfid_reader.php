      ...
      <div class="col p-md-0">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
               <a href="javascript:void(0)">RFID Reader Master</a>
            </li>
         </ol>
      </div>
   </div>
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
                     <div class="card-header">RFID Reader Master</div>
                  </div>
                  <div class="card-body">
                     <div class="basic-form">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url('index.php/Master/rfid_reader');?>" method="POST">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">
                              <b>Reader Location Name</b>
                              </label>
                              <div class="col-sm-8">
                                 <input class="form-control input-rounded" name="reader_location" value="<?php echo set_value('reader_location'); ?>" required>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-sm-10">
                  ...
                  <div class="card-body">
                     <script>
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to delete RFID Reader Location permanently?");
                        ...
                        
                        {
                            ...
                            job=confirm("Are you sure to Edit RFID Reader Location ?");
                     ...
                     <div class="table-responsive" style="overflow-x:auto; ">
                        <table id="example" class=" table-striped table-bordered zero-configuration">
                           ...
                           <tbody>
                              <?php  $count=1;
                                 if(!empty($reader_location)){
                                 
                                 foreach($reader_location as $row){ ?>
                              <tr>
                                 <td><?= $count; ?></td>
                                 <td><?= $row['id']; ?></td>
                                 ...
                                 <td>
                                    ...
                                    <a href="<?= base_url('Master/Delete_rfid_reader/'.$row['id']); ?>">
                                    ...
                                    <a href="<?= base_url('Master/Edit_rfid_reader/'.$row['id']); ?>">
