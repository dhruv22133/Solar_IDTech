...
<div class="content-body">
  <div class="row page-titles mx-0"><div class="col p-md-0"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
      ...
      <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Privilledge</a></li></ol></div></div>
  <!-- row -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="col-lg-12 bg-primary text-white" style="background-color:#495057!important;">
              <div class="card-header">Add Privilledge</div>
            </div>
            <div class="card-body">
              <div class="basic-form">
                ...
                <form action="<?php echo base_url('index.php/UserManagement/AddRole');?>" method="POST">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Privilledge Name</label>
                    <div class="col-sm-8">
                      <input class="form-control input-rounded" name="Role_name" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-10">
                      <button type="submit" name="submit" class="btn btn-primary">Add Privilledge</button>
                    </div>
                  </div>
                </form>
              </div>
